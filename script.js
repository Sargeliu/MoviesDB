...
const firstMovieRating = prompt('На сколько оцените его?');
const secondMovie = prompt('Один из последних просмотренных фильмов?');
const secondMovieRating = prompt('На сколько оцените его?');

personalMovieDB.movies[firstMovie] = firstMovieRating;
personalMovieDB.movies[secondMovie] = secondMovieRating;
